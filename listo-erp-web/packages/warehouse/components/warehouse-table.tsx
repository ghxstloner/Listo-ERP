...
interface WarehouseTableProps {
  ...
  isDeleting: boolean;
  deletingWarehouseId: number | null;
  t: TFunction;
...
>): ColumnDef<Warehouse>[] {
  return [
    ...
    },
    {
      ...
      header: ({ column }) => (
        <SortableHeader column={column}>
          {t("company.warehouses.createdAt")}
        </SortableHeader>
      ),
    ...
    },
    {
      id: "actions",
      header: () => (
        <div className="text-right">{t("company.warehouses.actions")}</div>
      ),
      cell: ({ row }) => (
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                ...
                disabled={isDeleting && deletingWarehouseId === row.original.id}
              >
...
export function WarehouseTable({
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
          <Input
            ...
            placeholder={t("company.warehouses.searchWarehouses")}
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <SelectTrigger size="default" className="min-w-40">
                  <SelectValue placeholder={t("company.warehouses.status")} />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="ALL">
                    {t("company.warehouses.allStatuses")}
                  </SelectItem>
      ...
      <DataTable table={table} emptyMessage={t("company.warehouses.noWarehouses")} />
