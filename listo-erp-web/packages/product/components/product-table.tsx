  ...
  return [
    {
      ...
      cell: ({ row }) => (
        <div className="min-w-0">
          <div className="truncate font-medium">{row.original.sku}</div>
      ...
      cell: ({ row }) => (
        <div className="min-w-0 text-sm">
          {row.original.subdepartment ? (
            <div className="truncate">{row.original.subdepartment.name}</div>
          ) : (
    ...
    },
    {
      id: "actions",
      header: () => (
        <div className="text-right">{t("inventory.products.actions")}</div>
      ),
      cell: ({ row }) => (
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                ...
                disabled={isDeleting && deletingProductId === row.original.id}
              >
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <SelectTrigger size="default" className="min-w-40">
                  <SelectValue placeholder={t("inventory.products.status")} />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="ALL">
                    {t("inventory.products.allStatuses")}
                  </SelectItem>
